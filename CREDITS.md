...
The raster images in `assets/img/` were sourced from freely-licensed
collections. Attribution below is provided to satisfy the license terms where
required (notably CC BY).

| File | Title / description | Author | License | Source |
| ---- | ------------------- | ------ | ------- | ------ |
