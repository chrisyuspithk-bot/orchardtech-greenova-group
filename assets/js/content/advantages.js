...
OG.register("advantages", {
  "zh": {
    ...
    "adv.eyebrow": "五大核心優勢",
    "adv.title": "為什麼是 OrchardTech Greenova",
    "adv.1.title": "雙業務風險對沖",
    ...
    "adv.2.body": "Pro-IAQ 與NEC達成長期深度戰略合作。作為世界500強科技巨頭的指定合作伙伴，NEC的選擇是對我們技術架構、研發能力與交付質量的最高認可，構築了難以複製的技術壁壘與品牌信任度。",
  ...
  "cn": {
    ...
    "adv.1.title": "双业务风险对冲",
    "adv.1.body": "Pro-IAQ 提供稳定年费模式的经常性收入（空气治理年费订阅 + IT硬件维保续约），回款周期短、现金流健康；GP Investment 依托AI技术壁垒实现高毛利增长。两大业务现金流完全独立、互补共生，形成「稳健+爆发」的组合优势，抗风险能力显著优于同业单一业务型公司。",
    "adv.2.title": "世界500强技术认证",
    "adv.2.body": "Pro-IAQ 与NEC达成长期深度战略合作。作为世界500强科技巨头的指定合作伙伴，NEC的选择是对我们技术架构、研发能力与交付质量的最高认可，构筑了难以复制的技术壁垒与品牌信任度。",
    "adv.3.title": "交叉销售协同增长",
    "adv.3.body": "客户群高度互补，形成「一客多买、互相导流」的增长飞轮。持续降低边际获客成本，最大化挖掘单客户的全生命周期价值与增长潜力。",
    "adv.4.title": "第二增长曲线",
  ...
  "en": {
    ...
    "adv.1.body": "Pro-IAQ delivers recurring revenue through stable subscription models (annual IAQ subscriptions + IT hardware maintenance renewals) with short payment cycles and healthy cash flow. GP Investment achieves high-margin growth through AI technology barriers. The two businesses operate with completely independent yet complementary cash flows, forming a “stable + explosive” combination — significantly superior risk resilience compared to single-business peers.",
    "adv.2.title": "Fortune 500 Technology Certification",
    "adv.2.body": "Pro-IAQ has established a long-term strategic partnership with NEC. As a designated partner of this Fortune 500 tech giant, NEC’s choice represents the highest recognition of our technical architecture, R&D capabilities, and delivery quality — building an unreplicable technology moat and brand trust.",
    "adv.3.title": "Cross-Selling Synergistic Growth",
    "adv.3.body": "Highly complementary client bases form a “one client, multiple purchases, mutual referrals” growth flywheel. Continuously reducing marginal customer acquisition costs while maximizing lifetime value of each client.",
    "adv.4.title": "Second Growth Curve",
