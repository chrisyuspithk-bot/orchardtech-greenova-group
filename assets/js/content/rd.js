...
OG.register("rd", {
  "zh": {
    ...
    "polyu.lead": "OrchardTech Greenova 與香港理工大學正式簽署合作協議，共同推進 「AI綠色智慧節能大廈」 系統的研發與商業化應用。集團作為合作統籌主體，整合旗下 Pro-IAQ 的室內空氣傳感器、空氣淨化設備與室內空氣管理平台，以及 GP Investment 的AI算法能力，打造獨一無二的大廈及辦公室冷氣節能 + 空氣監測 + 自動優化系統。",
    "polyu.core.h": "合作核心",
    ...
    "ms.sig.2.t": "標杆效應",
    "ms.sig.2.d": "香港科學園作為粵港澳大灣區創科高地，其深圳分院的上線為系統提供了極具說服力的示範案例",
    "ms.sig.3.t": "技術驗證",
